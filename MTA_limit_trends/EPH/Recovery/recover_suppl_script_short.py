...
#
#data_dir = '/data/mta/Script/MTA_limit_trends/Scripts/EPH/Work/Outdir/'
data_dir = './Outdir/'
glist    = ['ephhk']
...
#
    ...
    day_list = []
    for year in range(2016, 2018):             #---- CHANGE CHANGE CHAGE!!!!! 
        lyear = year
        for mon in range(1, 13):
            if year == 2016 and mon < 11:
                continue
            if year == 2017 and mon > 12:
                break 
...
#
#        create_fits_file(fits3, cols, week_d)
