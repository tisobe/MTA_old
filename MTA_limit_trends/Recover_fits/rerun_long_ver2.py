...
#####################################################################################    
#                                                                                   #
#           rerun_long.py:  recover long term data from ska                         #
#                           this version update at a month unit, which is safer     #
#                           than done by one full length                            #
#                                                                                   #
...
def get_limit(msid, tchk, mta_db, mta_cross):
    ...
    ###print "I AM HERE MCHK: " + str(mchk)
    if mchk == 'mta':
        try:
            glim = mta_db[msid]
            ###print "I AM HERE XX1: " + str(glim)
        except:
...
#
    ...
    while end <= pstop:
        ...
        if end > pstop:
            ...
            update_fits_file(fits, cols, short_p)
            break
#
        ...
        if os.path.isfile(fits):
            ...
            create_fits_file(fits, cols, short_p)
