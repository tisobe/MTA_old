...
#           this is colossus-v version                                                                      #
#                                                                                                           #
#           author: t. isobe (tisobe@cfa.harvard.edu)                                                       #
#                                                                                                           #
#           Last Update: Apr 06, 2018                                                                       #
#                                                                                                           #
#############################################################################################################
...
#
    cfile = house_keeping  + 'Records/colossus-v'+ '_' + user
...
def record_error(fname, stime, error_list):
    ...
    file = house_keeping + 'Records/colossus-v' + '_' + user + '_error_list'
