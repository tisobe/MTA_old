...
#################################################################################
#                                                                               #
#       hrci_plot.perl: plottting hrc i  data                                   #
#                                                                               #
...
$title = 'HRC I Pointing Errors in Y axis (Obs - Nominal)';
...
$title = 'HRC I Pointing Errors in  Z axis (Obs - Nominal)';
...
system("echo ''|gs -sDEVICE=ppmraw  -r256x256 -q -NOPAUSE -sOutputFile=-  pgplot.ps| pnmflip -r270 | ppmtogif > $web_dir/Fig_save/hrc_i_point_err.gif");
