...
$title = 'ACIS Pointing Errors in Y axis (Obs - Nominal)';
...
$title = 'ACIS Pointing Errors in  Z axis (Obs - Nominal)';
...
system("echo ''|gs -sDEVICE=ppmraw  -r256x256 -q -NOPAUSE -sOutputFile=-  pgplot.ps| pnmflip -r270 | ppmtogif > $web_dir/Fig_save/acis_point_err.gif");
