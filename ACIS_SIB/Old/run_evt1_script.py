...
import sib_corr_comp_sib    as sccs
...
def process_evt(lev= 'Lev1'):
    ...
    for obs in data:
        ...
        #cmd1 = '/usr/bin/env PERL5LIB="" source /home/mta/bin/reset_param; '
        cmd1 = '/usr/bin/env PERL5LIB=""  '
