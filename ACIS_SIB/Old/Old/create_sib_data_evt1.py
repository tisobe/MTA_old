...
#############################################################################################################
#                                                                                                           #
#           create_sib_data_evt1.py: create sib data for report (Lev 1)                                     #
#                                                                                                           #
...
#-----------------------------------------------------------------------------------------
#-- create_sib_data_evt1: create sib data for report (Lev 1)                            --
#-----------------------------------------------------------------------------------------

def create_sib_data_evt1():
    """
    """
#
...
#
    ...
    cmd2 = ' perl ' + s_dir + 'Lev1/correct_factor.perl'
    cmd  = cmd1 + cmd2
...
#
    cmd1 = "/usr/bin/env PERL5LIB="
    cmd2 = ' perl  ' + s_dir + 'Lev1/move_exess_list.perl'
    cmd  = cmd1 + cmd2
    bash(cmd,  env=ascdsenv)
#
#---   combine the data
...
#
    ...
    cmd   = 'mv ' + s_dir  + 'Lev1/Data/* ' + dname
    os.system(cmd)
#
#--- plot data
#
    cmd = s_dir + 'Scripts/ccd_comb_plot.py'
    os.system(cmd)
    cmd = s_dir + 'Scripts/update_html.py'
    os.system(cmd)
#
#--- clean updata
#
    ...
    cmd = 'mv ' + s_dir + 'Lev1/Outdir/lres ' 
    cmd = cmd   + s_dir + 'Lev1/Outdir/lres_' + lmon +str(syear) + '_modified'
    os.system(cmd)

    cmd = 'rm -rf ' + s_dir + 'Lev1/Outdir/ctirm_dir'
    #os.system(cmd)
    cmd = 'rm -rf ' + s_dir + 'Lev1/Outdir/filtered'
    #os.system(cmd)
    cmd = 'rm -rf ' + s_dir + 'Lev1/Outdir/hres'
    #os.system(cmd)
