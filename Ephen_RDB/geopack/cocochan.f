...
c      open(unit=1,name='/data/mta/Script/Ephem/PE.EPH.dat')
c      open(unit=2,name='/data/mta/Script/Ephem/PE.EPH.gsme')
      open(unit=1,name='/data/mta/Script/Ephem/Exc/dephem.dat')
      open(unit=2,name='/data/mta/Script/Ephem/Exc/dephem.gsme')
c      open(unit=3,name='/data/mta/Script/Ephem/PE.EPH.gsme_in_Re')
