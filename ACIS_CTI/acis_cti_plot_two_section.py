...
#--- fit a line
#
    (intList, slopeList, serrList, intList2, slopeList2, serrList2) = fitLines(xSets, ySets, ydiv, echk=0)
#
#--- plot five panel plots (eSets added 4/24/14)
#
    plotPanel(xmin, xmax, yMinSets, yMaxSets, xSets, ySets, xname, yname, entLabels, ydiv,  yErrs = eSets, intList = intList, slopeList = slopeList, intList2= intList2, slopeList2=slopeList2)
...
#
                ...
                (intList, slopeList, serrList, intList2, slopeList2, serrList2) = fitLines(xSets, ySets, ydiv)
...
#
                    line = "%3e\t%3e\t%3e\t%3e\t" % (slopeList[i], serrList[i], slopeList2[i], serrList2[i])
                    fo.write(line)
...
#--- create the plot
#
                plotPanel(xmin, xmax, yMinSets, yMaxSets, xSets, ySets, xname, yname, entLabels, ydiv, yErrs = yErrs, intList = intList, slopeList = slopeList, intList2= intList2, slopeList2=slopeList2)
...
#
            ...
            sccd_list = [0, 1, 2, 3]
            (xmin, xmax, ymin, ymax, newX, newY, newE, intc, slope, serr, intc2, slope2, serr2) = prepPartPlot(elm, sccd_list, 'imaging', indirs[k], outdirs[k])
            ...
            sccd_list = [4, 6, 7, 9]
            (xmin, xmax, ymin, ymax, newX, newY, newE, intc, slope, serr, intc2, slope2, serr2) = prepPartPlot(elm, sccd_list, 'spectral', indirs[k], outdirs[k])
            ...
            if allccd == 1:
                sccd_list = [5]
                (xmin, xmax, ymin, ymax, newX, newY, newE, intc, slope, serr, intc2, slope2, serr2) = prepPartPlot(elm, sccd_list, 'backside_5', indirs[k], outdirs[k])
                ...
                sccd_list = [7]
                (xmin, xmax, ymin, ymax, newX, newY, newE, intc, slope, serr, intc2, slope2, serr2) = prepPartPlot(elm, sccd_list, 'backside_7', indirs[k], outdirs[k])
...
#--- create a title label for plot
#
    return (xmin, xmax, ymin, ymax, newX, newY, newE, intList[0], slopeList[0], serrList[0], intList2[0],  slopeList2[0], serrList2[0])
...
#
            ...
            plotPanel(xmin, xmax, yMinSets, yMaxSets, xSets, ySets, xname, yname, name_list, ydiv, yErrs = yErrs, intList = intList, slopeList = slopeList, intList2 = intList2, slopeList2 = slopeList2)
...
#--- add legend
#
        ltext = entLabels[i] + ' / Slope (CTI/Day): ' + str(round(slopeList[i] * 1.0e2, 3)) + ' x 10**-2  / '
...
#    plot_data3()                               #--- discontinued (5/21/2014)
